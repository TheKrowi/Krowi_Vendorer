...
L["TooltipShowAutoSellRules"] = "Show auto-sell rules in item tooltips"
L["TooltipShowAutoSellRules Desc"] = "Show which auto-sell rules an item matches in the item tooltip."
L["AutoSellPrintChatMessage"] = "Print auto-sell messages in chat"
L["AutoSellPrintChatMessage Desc"] = "Print messages in chat when items are sold automatically."
L["Tooltip"] = true
L["Levels of details"] = true
L["Levels of details Desc"] = "Select the level of details shown in item tooltips."
L["Conditions are read only"] = "This rule is a preset rule. Conditions are read only. Any changes made to the conditions will be reverted."
L["Inventory Type"] = true
L["None"] = true
L["Basic"] = true
L["Detailed"] = true
L["Rules"] = true
...
L["Vendor price must be a valid number."] = "Vendor price must be a valid number."
L["Gold"] = "Gold"
L["Silver"] = "Silver"
L["Copper"] = "Copper"
...
L["Item Level vs Equipped"] = "Item Level vs Equipped"
