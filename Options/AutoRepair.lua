        ...
        General = {
            ...
            args = {
                IsEnabled = {
                    ...
                    get = function() return addon.Options.db.AutoRepair.IsEnabled; end,
                    set = function()
                        addon.Options.db.AutoRepair.IsEnabled = not addon.Options.db.AutoRepair.IsEnabled;
                    end
                },
                IsGuildEnabled = {
                    order = OrderPP(), type = "toggle", width = "full",
                    name = addon.L["Auto Repair Is Guild Enabled"],
                    get = function() return addon.Options.db.AutoRepair.IsGuildEnabled; end,
                    set = function()
                        addon.Options.db.AutoRepair.IsGuildEnabled = not addon.Options.db.AutoRepair.IsGuildEnabled;
                    end
                },
                PrintChatMessage = {
                    order = OrderPP(), type = "toggle", width = "full",
                    name = addon.L["Auto Repair Print Chat Message"],
                    get = function() return addon.Options.db.AutoRepair.PrintChatMessage; end,
                    set = function()
                        addon.Options.db.AutoRepair.PrintChatMessage = not addon.Options.db.AutoRepair.PrintChatMessage;
                    end
                }
            }
        }
