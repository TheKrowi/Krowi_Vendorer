...
function itemList.LeftItemOnClick(self, frame)
    frame:AppendListItem(dualItemListSide.Right, self.ElementData.Link, self.ElementData.Icon, self.ElementData.Color, self.ElementData.Name);
    frame:RemoveListItem(dualItemListSide.Left, self.ElementData);
end

function itemList.RightItemOnClick(self, frame)
    frame:AppendListItem(dualItemListSide.Left, self.ElementData.Link, self.ElementData.Icon, self.ElementData.Color, self.ElementData.Name);
